...
type User struct {
	...
	// Orders      []Order     `gorm:"foreignKey:UserID;constraint:OnDelete:CASCADE"` // 一對多，級聯刪除，方便測試 先mark
	// UserOrders []UserOrder `gorm:"foreignKey:UserID;constraint:OnDelete:CASCADE"` // 一對多，級聯刪除，方便測試 先mark
	BaseModel
}
